...
func NewCauseHandler(causeService services.CauseService) *CauseHandler {
	return &CauseHandler{
...
func (h *CauseHandler) CreateCause(w http.ResponseWriter, r *http.Request) {
	...
	if req.OrganizationID.String() == "" || req.Title == "" || req.DomainID.String() == "" || req.AidTypeID.String() == "" {
		http.Error(w, "OrganizationID, title, domainID, aidTypeId required", http.StatusBadRequest)
		return
	}

	cause, err := h.causeService.Create(r.Context(), &req)
	if err != nil {
...
func (h *CauseHandler) GetCauseByID(w http.ResponseWriter, r *http.Request) {
	var req models.CauseByIDRequest
	...
	cause, err := h.causeService.GetByID(r.Context(), req.ID)
	if err != nil {
		http.Error(w, err.Error(), http.StatusBadRequest)
		return
	}
...
//
// func (h *CauseHandler) RegisterUser(w http.ResponseWriter, r *http.Request) {
...
// }
//
// func (h *CauseHandler) RegisterOrganization(w http.ResponseWriter, r *http.Request) {
...
// }
//
// func (h *CauseHandler) Login(w http.ResponseWriter, r *http.Request) {
...
// }
//
// func (h *CauseHandler) GetMe(w http.ResponseWriter, r *http.Request) {
...
// func (h *CauseHandler) BeginAuth(w http.ResponseWriter, r *http.Request) {
...
// 		return
// 	}
// 	gothic.BeginCauseHandler(w, r)
// }
//
// // CompleteAuth completes the OAuth flow and logs the user in
// func (h *CauseHandler) CompleteAuth(w http.ResponseWriter, r *http.Request) {
...
// }
//
// func (h *CauseHandler) Logout(w http.ResponseWriter, r *http.Request) {
